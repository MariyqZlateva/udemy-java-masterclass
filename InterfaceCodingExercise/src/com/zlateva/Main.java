...
//  It initialises name, hitPoints and strength with the newly passed in values. It initialises weapon with the default weapon "Sword".
// - And eleven methods:
...
//    Check if you've added a constructor or if the constructor has the right arguments.
    ...
    public static void main(String[] args) {
        Player mimi = new Player("Mimi", 10, 15);
        System.out.println(mimi);


        mimi.setHitPoints(8);
        System.out.println(mimi);
        mimi.setWeapon("Stormbringer");
