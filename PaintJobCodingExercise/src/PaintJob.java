...
//   *getBucketCount(3.4, 2.1, 1.5, 2); → should return 3 since the wall area is 7.14,
//   a single bucket can cover an area of 1.5 and Bob has 2 extra buckets home.
//   *getBucketCount(2.75, 3.25, 2.5, 1); → should return 3 since the wall area is 8.9375,
//   a single bucket can cover an area of 2.5 and Bob has 1 extra bucket at home.
...
//   3. In some cases, Bob does not know the width and height of the wall,
...
//    NOTE: Do not add the main method to the solution code.
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double bucket = ((Math.ceil(area / areaPerBucket))-extraBuckets);
...
//        }
//        if (area > (extraArea)) {
//            double tempArea = area - extraArea;
//            buckets = (int) Math.ceil(tempArea / areaPerBucket);
//        }
//        return buckets;
//    }
//
