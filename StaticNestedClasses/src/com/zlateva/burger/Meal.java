...
public class Meal {
    ...
    public Meal(double conversionRate) {
        ...
        drink = new Item("cocke", "drink", 1.5);
    ...
    public String toString() {
        return String.format("%s%n%s%n%s%n%26s$%.2f", burger, drink, side,
                "Total Due: ", getTotal());
    }
    ...
    private class Item {
        ...
        @Override
        public String toString() {
            return String.format("%10s%15s $%.2f", type, name,
